...
.element_<?php echo $galleryID; ?> {
	width: 100%;
	max-width: <?php echo get_option('ht_view2_element_width')+2*get_option('ht_view2_element_border_width'); ?>px;
	height: <?php echo get_option('ht_view2_element_height')+45+2*get_option('ht_view2_element_border_width'); ?>px;
	margin: 0 10px 10px 0;
	background: #<?php echo get_option('ht_view2_element_background_color'); ?>;
	border: <?php echo get_option('ht_view2_element_border_width'); ?>px solid #<?php echo get_option('ht_view2_element_border_color'); ?>;
	outline: none;
}
.element_<?php echo $galleryID; ?>.no-title{
	height: <?php echo get_option('ht_view2_element_height')+2*get_option('ht_view2_element_border_width'); ?>px;
}
.element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?> {
<?php if(get_option('image_natural_size_contentpopup')=='resize'){?> position: relative;
	width: 100%;
<?php }elseif(get_option('image_natural_size_contentpopup')=='natural'){?> position: relative;
	width: 100%;
	overflow: hidden;
	height: <?php echo get_option('ht_view2_element_height'); ?>px !important;
<?php }?>
}

.element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?> img {
<?php if(get_option('image_natural_size_contentpopup')=='resize'){?> width: 100% !important;
	height: <?php echo get_option('ht_view2_element_height'); ?>px !important;
	display: block;
	border-radius: 0 !important;
	box-shadow: 0 0 0 rgba(0, 0, 0, 0) !important;
<?php }elseif(get_option('image_natural_size_contentpopup')=='natural'){?> display: block;
...
.element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?> .gallery-image-overlay {
	...
	height: 100%;
	background: <?php
			list($r,$g,$b) = array_map('hexdec',str_split(get_option('ht_view2_element_overlay_color'),2));
				$titleopacity=get_option("ht_view2_element_overlay_transparency")/100;
...
.element_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?> .gallery-image-overlay a {
	...
	background: url('<?php echo  GALLERY_IMG_IMAGES_URL.'/admin_images/zoom.'.get_option("ht_view2_zoombutton_style").'.png'; ?>') center center no-repeat;
}
...
.element_<?php echo $galleryID; ?> .title-block_<?php echo $galleryID; ?> h3 {
	...
	white-space: nowrap;
	font-weight: normal;
	font-size: <?php echo get_option("ht_view2_element_title_font_size");?>px !important;
	line-height: <?php echo get_option("ht_view2_popup_title_font_size");?>px !important;
	color: #<?php echo get_option("ht_view2_element_title_font_color");?>;
}
...
.element_<?php echo $galleryID; ?> .title-block_<?php echo $galleryID; ?> a:hover, .element_<?php echo $galleryID; ?> .title-block_<?php echo $galleryID; ?> a:focus, .element_<?php echo $galleryID; ?> .title-block_<?php echo $galleryID; ?> a:active {
	...
	border-radius: 3px;
	font-size: <?php echo get_option("ht_view2_element_linkbutton_font_size");?>px;
	background: #<?php echo get_option("ht_view2_element_linkbutton_background_color");?>;
	color: #<?php echo get_option("ht_view2_element_linkbutton_color");?>;
...
.load_more5 {
	margin: 10px 0;
	position: relative;
	text-align: <?php if(get_option('video_ht_view1_loadmore_position') == 'left') {echo 'left';}
			elseif (get_option('video_ht_view1_loadmore_position') == 'center') { echo 'center'; }
			elseif(get_option('video_ht_view1_loadmore_position') == 'right') { echo 'right'; }?>;
	width: 100%;
}
...
.load_more_button5 {
	...
	padding: 5px 15px;
	font-size: <?php echo get_option('video_ht_view1_loadmore_fontsize'); ?>px !important;;
	color: <?php echo '#'.get_option('video_ht_view1_loadmore_font_color'); ?> !important;;
	background: <?php echo '#'.get_option('video_ht_view1_button_color'); ?> !important;
	cursor: pointer;
}

.load_more_button5:hover {
	color: <?php echo '#'.get_option('video_ht_view1_loadmore_font_color_hover'); ?> !important;
	background: <?php echo '#'.get_option('video_ht_view1_button_color_hover'); ?> !important;
}
...
.paginate5 {
	font-size: <?php echo get_option('video_ht_view1_paginator_fontsize'); ?>px !important;
	color: <?php echo '#'.get_option('video_ht_view1_paginator_color'); ?> !important;
	text-align: <?php echo get_option('video_ht_view1_paginator_position'); ?>;
	margin-top: 15px;
}
...
.icon-style5 {
	font-size: <?php echo get_option('video_ht_view1_paginator_icon_size'); ?>px !important;
	color: <?php echo '#'.get_option('video_ht_view1_paginator_icon_color'); ?> !important;
}
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> li.pupup-element {
	...
	min-height: 100%;
	position: relative;
	background: #<?php echo get_option("ht_view2_popup_background_color");?>;
}
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .heading-navigation_<?php echo $galleryID; ?> .close, #huge_it_gallery_popup_list_<?php echo $galleryID; ?> .heading-navigation_<?php echo $galleryID; ?> .close:link, #huge_it_gallery_popup_list_<?php echo $galleryID; ?> .heading-navigation_<?php echo $galleryID; ?> .close:visited {
	...
	height: 40px;
	display: block;
	background: url('<?php echo  GALLERY_IMG_IMAGES_URL.'/admin_images/close.popup.'.get_option("ht_view2_popup_closebutton_style").'.png'; ?>') center center no-repeat;
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .popup-wrapper_<?php echo $galleryID; ?> .image-block_<?php echo $galleryID; ?> {
	width: 55%;
<?php if(get_option('ht_view2_popup_full_width') == 'off') { echo "height:100%;"; }
...
<?php
	if(get_option('ht_view2_popup_full_width') == 'off') { echo "max-width:100% !important; max-height:100% !important;margin: 0 auto !important; position:relative !important; display:block;"; }
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> li.pupup-element .popup-wrapper_<?php echo $galleryID; ?> .right-block > div {
	...
	padding-right: 4%;
	margin-bottom: 10px;
<?php if(get_option('ht_view2_show_separator_lines')=="on") {?> background: url('<?php echo  GALLERY_IMG_IMAGES_URL.'/admin_images/divider.line.png'; ?>') center top repeat-x;
<?php } ?>
}
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .popup-wrapper_<?php echo $galleryID; ?> .right-block .title {
	...
	font-size: <?php echo get_option("ht_view2_popup_title_font_size");?>px !important;
	line-height: <?php echo get_option("ht_view2_popup_title_font_size");?>px !important;
	color: #<?php echo get_option("ht_view2_popup_title_font_color");?>;
}
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .popup-wrapper_<?php echo $galleryID; ?> .right-block .description {
	...
	font-weight: normal;
	text-align: justify;
	font-size: <?php echo get_option("ht_view2_description_font_size");?>px !important;
	color: #<?php echo get_option("ht_view2_description_color");?>;
}
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .popup-wrapper_<?php echo $galleryID; ?> .right-block ul.thumbs-list li {
	display: block;
	float: left;
	width: <?php echo get_option("ht_view2_thumbs_width");?>px;
	height: <?php echo get_option("ht_view2_thumbs_height");?>px;
...
#huge_it_gallery_popup_list_<?php echo $galleryID; ?> .popup-wrapper_<?php echo $galleryID; ?> .right-block ul.thumbs-list li img {
	width: <?php echo get_option("ht_view2_thumbs_width");?>px !important;
	height: <?php echo get_option("ht_view2_thumbs_height");?>px !important;
}
...
.pupup-element .button-block a, .pupup-element .button-block a:link, .pupup-element .button-block a:visited {
	...
	display: inline-block;
	padding: 6px 12px;
	background: #<?php echo get_option("ht_view2_popup_linkbutton_background_color");?>;
	color: #<?php echo get_option("ht_view2_popup_linkbutton_color");?>;
	font-size: <?php echo get_option("ht_view2_popup_linkbutton_font_size");?>px;
	text-decoration: none;
}

.pupup-element .button-block a:hover, .pupup-element .button-block a:focus, .pupup-element .button-block a:active {
	background: #<?php echo get_option("ht_view2_popup_linkbutton_background_hover_color");?>;
	color: #<?php echo get_option("ht_view2_popup_linkbutton_font_hover_color");?>;
}
...
#huge-popup-overlay-image {
	...
	z-index: 199;
	background: <?php
			list($r,$g,$b) = array_map('hexdec',str_split(get_option('ht_view2_popup_overlay_color'),2));
				$titleopacity=get_option("ht_view2_popup_overlay_transparency_color")/100;
				echo 'rgba('.$r.','.$g.','.$b.','.$titleopacity.')  !important';
	?>
}
...
#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> {
	float: right;
	color: #<?php echo get_option('ht_popup_likedislike_font_color'); ?>;
}
...
#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .huge_it_gallery_dislike_wrapper {
	position: relative;
	background: <?php
			list($r,$g,$b) = array_map('hexdec',str_split(get_option('ht_popup_likedislike_bg'),2));
				$titleopacity=get_option("ht_popup_likedislike_bg_trans")/100;
				echo 'rgba('.$r.','.$g.','.$b.','.$titleopacity.')  !important';
	?>;
	display: inline-block;
	border-radius: 3px;
...
#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_thumb_up {
	...
	top: 5px;
	left: 4px;
	color: #<?php echo get_option('ht_popup_likedislike_thumb_color'); ?>;
}
...
#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_thumb_active {
	color: #<?php echo get_option('ht_popup_likedislike_thumb_active_color'); ?> !important;
}

#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_font_active {
	color: #<?php echo get_option('ht_popup_active_font_color'); ?> !important;
}
...
#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .huge_it_gallery_like_wrapper:hover {
	background: #<?php echo get_option('ht_popup_heart_hov_bg_color'); ?>;
}
...
#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .huge_it_like .huge_it_like_thumb {
	...
	float: left;
<?php $heartCount='';
if(get_option('ht_popup_rating_count')=='off'){
	$heartCount="transparent";
}else{
	$heartCount='#'.get_option('ht_popup_likedislike_font_color');
}
...
#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .huge_it_like .likeheart {
	font-size: 32px;
	color: #<?php echo get_option('ht_popup_heart_likedislike_thumb_color'); ?>;
	position: absolute;
	top: 4px;
	left: 3px;
...
#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_thumb_active {
	color: #<?php echo get_option('ht_popup_heart_likedislike_thumb_active_color'); ?> !important;
}

#huge_it_gallery_content_<?php echo $galleryID; ?> .huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_font_active {
<?php if(get_option('ht_popup_rating_count')!='off'):?> color: #<?php echo get_option('ht_popup_active_font_color'); ?> !important;
<?php endif; ?>
}
