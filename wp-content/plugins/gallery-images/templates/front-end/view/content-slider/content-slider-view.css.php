<style>
* {outline:none;}
#g-main-slider_<?php echo $galleryID; ?> {background:#<?php echo get_option("ht_view5_slider_background_color");?>;}
.entry-content a{
	border-bottom: none;
}
#g-main-slider_<?php echo $galleryID; ?> div.slider-content {
	...
	padding:0 0 0 0;
	position:relative;
	background:#<?php echo get_option("ht_view5_slider_background_color");?>;
}
[class$="-arrow"] {
	background-image:url(<?php echo GALLERY_IMG_IMAGES_URL.'/admin_images/arrow.'.get_option("ht_view5_icons_style").'.png';?>) !important;
}
.ls-select-box {
	background:url(<?php echo GALLERY_IMG_IMAGES_URL.'/admin_images/menu.'.get_option("ht_view5_icons_style").'.png';?>) right center no-repeat #<?php echo get_option("ht_view5_slider_background_color");?>;
}
#g-main-slider_<?php echo $galleryID; ?>-nav-select {
	color:#<?php echo get_option("ht_view5_title_font_color");?>;
}
...
#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .image-block_<?php echo $galleryID; ?> {
	position:relative;
	width:<?php echo get_option("ht_view5_main_image_width");?>px;
	display:table-cell;
	padding:0 10px 0 0;
	float:left;
}
...
#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .right-block > div {
	padding-bottom:10px;
	margin-top:10px;
<?php if(get_option('ht_view5_show_separator_lines')=="on") {?>
...
#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .right-block .title {
	...
	display:block;
	margin:-10px 0 0 0;
	font-size:<?php echo get_option("ht_view5_title_font_size");?>px !important;
	line-height:<?php echo get_option("ht_view5_title_font_size");?>px !important;
	color:#<?php echo get_option("ht_view5_title_font_color");?>;
}
#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .right-block .description {
	...
	font-weight:normal;
	text-align:justify;
	font-size:<?php echo get_option("ht_view5_description_font_size");?>px !important;
	line-height:<?php echo get_option("ht_view5_description_font_size");?>px !important;
	color:#<?php echo get_option("ht_view5_description_color");?>;
}
...
#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a,#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a:link,#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a:visited{
	...
	padding:6px 12px;
	background:#<?php echo get_option("ht_view5_linkbutton_background_color");?>;
	color:#<?php echo get_option("ht_view5_linkbutton_color");?>;
	font-size:<?php echo get_option("ht_view5_linkbutton_font_size");?>px;
...
#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a:hover,#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a:focus,#g-main-slider_<?php echo $galleryID; ?> .slider-content-wrapper .button-block a:active {
	background:#<?php echo get_option("ht_view5_linkbutton_background_hover_color");?>;
	color:#<?php echo get_option("ht_view5_linkbutton_font_hover_color");?>;
}
...
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?>{
	color: #<?php echo get_option('ht_contentsl_likedislike_font_color'); ?>;
	position: relative;
...
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?>	.huge_it_gallery_dislike_wrapper {
	position:relative;
	background:<?php
			list($r,$g,$b) = array_map('hexdec',str_split(get_option('ht_contentsl_likedislike_bg'),2));
				$titleopacity=get_option("ht_contentsl_likedislike_bg_trans")/100;
...
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_thumb_up{
	...
	top: 5px;
	left: 4px;
	color:#<?php echo get_option('ht_contentsl_likedislike_thumb_color'); ?>;
}
...
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_thumb_active{
	color: #<?php echo get_option('ht_contentsl_likedislike_thumb_active_color'); ?> !important;
}
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_font_active{
	color: #<?php echo get_option('ht_contentsl_active_font_color'); ?> !important;
}
...
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .huge_it_like .huge_it_like_thumb {
	...
	float: left;
<?php $heartCount='';
if(get_option('ht_contentsl_rating_count')=='off'){
	$heartCount="transparent";
}else{
	$heartCount='#'.get_option('ht_contentsl_likedislike_font_color');
}
?>
...
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .huge_it_like  .likeheart{
	font-size: 32px;
	color:#<?php echo get_option('ht_contentsl_heart_likedislike_thumb_color'); ?>;
	position: absolute;
	top: 4px;
	left: 3px;
...
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_thumb_active{
	color: #<?php echo get_option('ht_contentsl_heart_likedislike_thumb_active_color'); ?> !important;
}
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_font_active{
<?php if(get_option('ht_contentsl_rating_count')!='off'):?>
	color: #<?php echo get_option('ht_contentsl_active_font_color'); ?> !important;
<?php endif; ?>
}
@media screen and (min-width: 768px){
