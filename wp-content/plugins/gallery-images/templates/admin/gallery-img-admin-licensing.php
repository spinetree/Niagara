...
<div style="width:95%">
	<p>
		You are using the Lite version of the Gallery Image for WordPress. If you want to get more awesome options,
	...
	<ol>
		<li>Deactivate Huge IT Gallery Plugin</li>
		<li>Delete Huge IT Gallery Plugin</li>
